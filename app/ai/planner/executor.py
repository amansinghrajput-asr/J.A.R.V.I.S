...
class Executor:
    ...
    def _resolve_from_container(
        ...
        elif action in ("capture_screen", "read_screen_text", "explain_active_window", "diagnose_screen_error", "ask_screen", "verify_screen_state", "locate_element", "detect_screen_change", "map_ui_scene"):
